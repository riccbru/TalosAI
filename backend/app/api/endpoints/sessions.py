...
async def get_all_sessions(
    ...
    sessions = await crud_sessions.get_user_sessions(
        db,
...
async def get_session_by_uuid(
    ...
    session = await crud_sessions.get_session_by_uuid(db, session_uuid=session_uid)
...
async def delete_sessionby_uuid():
    return {}
